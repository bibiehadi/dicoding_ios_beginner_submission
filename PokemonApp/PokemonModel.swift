...
let pokemons = [
    PokemonModel(
        ...
        type: "fire",
        photo: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/6.png",
        weakness: ["Water", "Electric", "Rock"],
        skills: ["Flamethrower (90)", "Fly (70)", "Dragon Claw (50)"],
        type_image: "https://archives.bulbagarden.net/media/upload/f/f9/Fire_icon_HOME3.png"
    ),
    PokemonModel(
        number: "#150",
        name: "Mewtwo",
        ...
        type: "psychic",
        photo: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/150.png",
        weakness: ["Bug", "Ghost", "Dark"],
        skills: ["Psystrike (100)", "Recover (0)", "Shadow Ball (50)"],
        type_image: "https://archives.bulbagarden.net/media/upload/2/2d/Psychic_icon_HOME3.png"
    ),
    PokemonModel(
        number: "#025",
        name: "Pikachu",
        ...
        type: "electric",
        photo: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/25.png",
        weakness: ["Ground"],
        skills: ["Thunderbolt (50)", "Quick Attack (20)", "Electro Ball (40)"],
        type_image: "https://archives.bulbagarden.net/media/upload/c/cf/Electric_icon_HOME3.png"
    ),
    PokemonModel(
        number: "#493",
        name: "Arceus",
        ...
        type: "normal",
        photo: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/493.png",
        weakness: ["Fighting"],
        skills: ["Judgment (100)", "Recover (0)", "Extreme Speed (60)"],
        type_image: "https://archives.bulbagarden.net/media/upload/8/8c/Normal_icon_HOME3.png"
    ),
    PokemonModel(
        number: "#384",
        name: "Raichu",
        ...
        type: "electric",
        photo: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/384.png",
        weakness: ["Ground"],
    ...
    PokemonModel(
        ...
        type: "normal",
        photo: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/133.png",
        weakness: ["Fighting"],
    ...
    PokemonModel(
        ...
        type: "ice",
        photo: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/448.png",
        weakness: ["Fire", "Electric", "Steel", "Rock"],
        skills: ["Blizzard (120)", "Hurricane (110)", "Roost (0)"],
        type_image: "https://archives.bulbagarden.net/media/upload/8/86/Ice_icon_HOME3.png"
    ),
    PokemonModel(
        number: "#658",
        name: "Jigglypuff",
        ...
        type: "fairy",
        photo: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/658.png",
        weakness: ["Steel", "Poison"],
        skills: ["Sing (0)", "Hyper Voice (70)", "Dazzling Gleam (80)"],
        type_image: "https://archives.bulbagarden.net/media/upload/0/0b/Fairy_icon_HOME3.png"
    ),
    PokemonModel(
        number: "#007",
        name: "Squirtle",
        ...
        type: "water",
        photo: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/7.png",
        weakness: ["Electric", "Grass"],
        skills: ["Water Gun (30)", "Aqua Tail (60)", "Protect (0)"],
        type_image: "https://archives.bulbagarden.net/media/upload/e/e7/Water_icon_HOME3.png"
    ),
    PokemonModel(
        number: "#001",
        name: "Bulbasaur",
        ...
        type: "grass",
        photo: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/1.png",
        weakness: ["Fire", "Psychic", "Flying", "Ice"],
        skills: ["Vine Whip (25)", "Razor Leaf (45)", "Leech Seed (30)"],
        type_image: "https://archives.bulbagarden.net/media/upload/8/81/Grass_icon_HOME3.png"
    ),
    PokemonModel(
        number: "#004",
        name: "Charmander",
        ...
        type: "fire",
        photo: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/4.png",
